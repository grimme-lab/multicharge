...
module multicharge_param_eeqbc2024
   ...
   real(wp), parameter :: eeqbc_chi(max_elem) = [&
      ...
      &  0.7504767353_wp,  0.9209739572_wp,  0.8712337946_wp,  0.8256069491_wp, & !89-92
   ...
   real(wp), parameter :: eeqbc_eta(max_elem) = [&
      ...
      & -0.1978172866_wp, -0.0137707685_wp, -0.0223759361_wp, -0.0323937506_wp, & !89-92
   ...
   real(wp), parameter :: eeqbc_rad(max_elem) = [&
      ...
      &  0.7680253432_wp,  1.3506770411_wp,  1.2357943143_wp,  1.1286142576_wp, & !89-92
   ...
   real(wp), parameter :: eeqbc_kcnchi(max_elem) = [&
      ...
      & -0.8544377521_wp, -0.9405783943_wp, -1.0100873130_wp, -1.0570453678_wp, & !89-92
   ...
   real(wp), parameter :: eeqbc_kqchi(max_elem) = [&
      ...
      &  2.7783783072_wp,  2.5882734739_wp,  2.6556922117_wp,  2.7152780818_wp, & !89-92
   ...
   real(wp), parameter :: eeqbc_kqeta(max_elem) = [&
      ...
      &  0.1237324721_wp,  0.1211096926_wp,  0.2542354374_wp,  0.3674348447_wp, & !89-92
   ...
   real(wp), parameter :: eeqbc_cap(max_elem) = [&
      ...
      &  1.7607856238_wp,  0.9287382385_wp,  1.1572187001_wp,  1.3496427135_wp, & !89-92
   ...
   real(wp), parameter :: eeqbc_cov_radii(max_elem) = 0.5_wp * [&
      ...
      &  3.2491640100_wp,  2.4938107984_wp,  2.8635632616_wp,  3.1787071560_wp, & !89-92
